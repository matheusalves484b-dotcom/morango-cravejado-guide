...
function SalesPage() {
  ...
  return <main className="sales-page">
    ...
    <section className="section offer-section" id="oferta"><div className="container offer-card"><div className="offer-ribbon">🍓 CONDIÇÃO ESPECIAL DE LANÇAMENTO</div><div className="offer-content"><div className="offer-copy"><div className="eyebrow">MORANGO CRAVEJADO</div><h2>Chegue cedo e comece a aprender antes que a novidade fique <span>comum.</span></h2><p>Tenha o guia para preparar, padronizar, precificar, apresentar e testar o Morango Cravejado no seu público.</p><div className="included"><b>O que está incluído:</b><span>✓ Guia completo de preparo e montagem</span><span>✓ Ficha técnica e organização de custos</span><span>✓ Estratégias de precificação</span><span>✓ Ideias de conteúdo e divulgação</span><span>✓ Orientações de embalagem e venda</span></div></div><div className="price-box"><div className="price-label">ACESSO AO GUIA DIGITAL</div><div className="old-price">de R$ 47,00</div><div className="price">R$ 10,00</div><div className="price-note">pagamento único</div><CTA>QUERO COMEÇAR AGORA</CTA><div className="secure"><ShieldCheck size={16}/> Compra protegida • acesso digital</div></div></div><div className="countdown"><div><b>⏳ CONDIÇÃO DE LANÇAMENTO</b><span>Condição promocional sujeita à alteração conforme a campanha.</span></div><div className="digits"><div><strong>{String(time.h).padStart(2,"0")}</strong><small>HORAS</small></div><i>:</i><div><strong>{String(time.m).padStart(2,"0")}</strong><small>MIN</small></div><i>:</i><div><strong>{String(time.s).padStart(2,"0")}</strong><small>SEG</small></div></div></div></div></section>
