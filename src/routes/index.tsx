...
function SalesPage() {
  ...
  return <main className="sales-page">
    ...
    <section className="hero"><div className="hero-glow"/><div className="container hero-grid"><div className="hero-copy"><div className="eyebrow"><Sparkles size={15}/> NOVA ONDA DOS DOCES ARTESANAIS</div><h1>O próximo doce que pode <em>parar o scroll</em> já tem nome.</h1><div className="hero-price"><span>GUIA COMPLETO POR APENAS</span><strong>R$ 10,00</strong></div><p className="hero-sub">Conheça o <strong>Morango Cravejado</strong>: morango, cremosidade, chocolate e crocância em uma apresentação criada para chamar atenção.</p><p className="hero-opportunity"><b>Não espere ficar lotado.</b> Aprenda, teste e descubra se essa novidade pode fazer sentido para o seu público.</p><CTA/><div className="microproof"><span>✓ Guia digital</span><span>✓ Passo a passo</span><span>✓ Preparo + venda</span></div></div><div className="hero-product"><div className="floating-badge"><span>🔥</span><b>NOVIDADE</b><small>chegue antes</small></div><img src={coverImage} alt="Guia digital Morango Cravejado" fetchPriority="high" decoding="async"/></div></div></section>
